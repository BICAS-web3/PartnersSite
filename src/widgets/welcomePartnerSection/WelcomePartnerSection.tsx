...
export const WelcomePartnerSection: FC<WelcomePartnerSectionProps> = () => {
  ...
  return (
    <div className={s.welcome_partner_section}>
      <div className={s.welcome_partner_body}>
        ...
        <div className={s.partner_statistic}>
          ...
          <div
            className={clsx(s.partner_percent_data, s.partner_percent_data_5)}
          >
            <Triangle className={s.partner_triangle_icon} />
            +60%
          </div>
          <div
            className={clsx(s.partner_percent_data, s.partner_percent_data_6)}
          >
            <Triangle className={s.partner_triangle_icon} />
            +65%
          </div>
